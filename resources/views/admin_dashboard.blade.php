	...
	<div class="row widget-grid">
		  ...
		  <div class="card-body">
			<div class="media">
			  ...
			  <div>  
				...
				<div class="p-0 badge f-10" id="txt"></div>
			  </div>
			</div>
	  ...
	  <div class="col-xxl-8 col-lg-12 box-col-12">
		<div class="card">
		  ...
		  <div class="pt-0 card-body">
			<div class="m-0 row overall-card">
			  <div class="p-0 col-xl-9 col-md-12 col-sm-7">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
			  ...
			  <div class="p-0 col-xl-3 col-md-12 col-sm-5">
			...
			<ul> 
			  <li class="d-flex">
				...
				<div class="w-100 ms-3">
				  <p class="mb-2 d-flex justify-content-between"><span class="date-content light-background">8th March, 2022 </span><span>1 day ago</span></p>
			  ...
			  <li class="d-flex">
				...
				<div class="w-100 ms-3">
				  <p class="mb-2 d-flex justify-content-between"><span class="date-content light-background">15th Oct, 2022 </span><span>Today</span></p>
			  ...
			  <li class="d-flex">
				...
				<div class="w-100 ms-3">
				  <p class="mb-2 d-flex justify-content-between"><span class="date-content light-background">20th Sep, 2022 </span><span>12:00 PM</span></p>
				  <h6>Tello just like your product<span class="dot-notification"></span></h6>
				  <p>Quisque a consequat ante sit amet magna... </p>
				</div>
			  </li>
				...
				<table class="table table-bordernone">
				  <tbody>
					<tr>
					  ...
					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('admin.profile')}}">Jane Cooper</a><span class="f-light">10 minutes ago</span></td>
					  <td class="text-end">
					...
					<tr>
					  ...
					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('admin.profile')}}">Brooklyn Simmons</a><span class="f-light">19 minutes ago</span></td>
					  <td class="text-end">
					...
					<tr>
					  ...
					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('admin.profile')}}">Leslie Alexander</a><span class="f-light">2 hours ago</span></td>
					  <td class="text-end">
					...
					<tr>
					  ...
					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('admin.profile')}}">Travis Wright</a><span class="f-light">8 hours ago</span></td>
					  <td class="text-end">
					...
					<tr>
					  ...
					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('admin.profile')}}">Mark Green</a><span class="f-light">1 day ago</span></td>
					  <td class="text-end">
	  ...
	  <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6"> 
		<div class="card papernote-wrap">
		  ...
		  <div class="pt-0 card-body"> <img class="banner-img img-fluid" src="{{ asset('assets/images/dashboard/papernote.jpg') }}" alt="multicolor background">
			<div class="mt-2 note-content mt-sm-4">
			  ...
			  <div class="mt-2 mt-sm-4 user-details">
				<div class="customers">
				  <ul> 
