    ...
    <div class="p-0 nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header ms-auto">
      <ul class="nav-menus">
        ...
        <li class="cart-nav onhover-dropdown">
          ...
          <div class="cart-dropdown onhover-show-div">
            ...
            <ul>
              ...
              <li class="text-center"><a class="mb-3 d-block view-cart f-w-700" href="#">Go to your cart</a><a class="btn btn-primary view-checkout" href="#">Checkout</a></li>
            </ul>
          </div>
        </li>
        <li class="onhover-dropdown">
        ...
        <li class="py-0 profile-nav onhover-dropdown pe-0">
          <div class="media profile-media"><img class="b-r-10" style="width: 35px" src="{{ (!empty($adminData->photo)) ? url('upload/admin_image/'.$adminData->photo) : url('upload/no_image.jpg') }}" alt="">
            <div class="media-body"><span>{{ $adminData->name }}</span>
              <p class="mb-0 font-roboto">{{ $adminData->role }} <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
