...
@section('title', 'Edit Annual Evaluation')
...
@section('breadcrumb-title')
    <h3>Edit Annual Employee Evaluation </h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">HR</li>
    <li class="breadcrumb-item active">Edit Annual Employee Evaluation </li>
@endsection
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('annual-employee-evaluation.update', $evaluation->id) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" id="job_title" class="form-control"
                                        value="{{ $evaluation->user ? $evaluation->user->job_title : '' }}" readonly>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="mb-4">
                            ...
                            <div class="mt-2 row">
                                <div class="col-md-6">
                                    <label class="form-label">Comments by head</label>
                                    <textarea class="form-control" rows="3" name="quality_of_work_comment_head" readonly>{{ $evaluation->quality_of_work_comment_head }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Comments by G.M</label>
                                    @if (auth()->user()->role == 'gm')
                                        <!-- Replace 'gm' with the actual role identifier for General Manager -->
                            ...
                            <div class="mb-4">
                                ...
                                <div class="btn-group w-100" role="group">
                                    ...
                                    <label class="btn btn-outline-primary" for="discipline2">Meets expectations</label>

                                    <input type="radio" class="btn-check" name="discipline_punctuality"
                                        id="discipline3" value="Needs improvement"
                                        {{ $evaluation->discipline_punctuality == 'Needs improvement' ? 'checked' : '' }}>
                                    <label class="btn btn-outline-warning" for="discipline3">Needs improvement</label>
                                ...
                                <div class="mt-2 row">
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by head</label>
                                        <textarea class="form-control" rows="3" name="discipline_punctuality_comment_head" readonly>{{ $evaluation->discipline_punctuality_comment_head }}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by G.M</label>
                                        @if (auth()->user()->role == 'gm')
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mt-2 row">
                                        <div class="col-md-6">
                                            <label class="form-label">Comments by head</label>
                                            <textarea class="form-control" rows="3"name="problem_solving_comment_head" readonly>{{ $evaluation->problem_solving_comment_head }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Comments by G.M</label>
                                            @if (auth()->user()->role == 'gm')
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mt-2 row">
                                        <div class="col-md-6">
                                            <label class="form-label">Comments by head</label>
                                            <textarea class="form-control" rows="3"name="conflict_management_comment_head" readonly>{{ $evaluation->conflict_management_comment_head }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Comments by G.M</label>
                                            @if (auth()->user()->role == 'gm')
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mt-2 row">
                                        <div class="col-md-6">
                                            <label class="form-label">Comments by head</label>
                                            <textarea class="form-control" rows="3"name="time_effectiveness_time_responsiveness_availability_comment_head"
                                                readonly>{{ $evaluation->time_effectiveness_time_responsiveness_availability_comment_head }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Comments by G.M</label>
                                            @if (auth()->user()->role == 'gm')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 row">
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by head</label>
                                        <textarea class="form-control" rows="3"name="initiative_flexibility_comment_head" readonly>{{ $evaluation->initiative_flexibility_comment_head }}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by G.M</label>
                                        @if (auth()->user()->role == 'gm')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 row">
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by head</label>
                                        <textarea class="form-control" rows="3"name="cooperation_teamwork_comment_head" readonly> {{ $evaluation->cooperation_teamwork_comment_head }}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by G.M</label>
                                        @if (auth()->user()->role == 'gm')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 row">
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by head</label>
                                        <textarea class="form-control" rows="3"name="knowledge_of_position_comment_head" readonly>{{ $evaluation->knowledge_of_position_comment_head }}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by G.M</label>
                                        @if (auth()->user()->role == 'gm')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 row">
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by head</label>
                                        <textarea class="form-control" rows="3"name="creativity_innovation_comment_head" readonly> {{ $evaluation->creativity_innovation_comment_head }}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Comments by G.M</label>
                                        @if (auth()->user()->role == 'gm')
                        ...
                        <section class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" rows="3" name="note">{{ $evaluation->note }}</textarea>
                            </div>
                        </section>
                        ...
                        <div class="pt-3 text-right ">
                            <div class="text-center d-flex justify-content-between" style="text-align: center">
