    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('annual-employee-evaluation.store') }}" method="post" class="form"
                            ...
                            <section class="mb-4">
                                ...
                                <div class="mt-2 row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" rows="3" name="quality_of_work_comment_head"></textarea>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mt-2 row">
                                        <div class="col-md-6">
                                            <label class="form-label">Comments by head</label>
                                            <textarea class="form-control" rows="3" name="discipline_punctuality_comment_head"></textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Comments by G.M</label>
                                            @if (auth()->user()->role == 'gm')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-2 row">
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by head</label>
                                                <textarea class="form-control" rows="3"name="problem_solving_comment_head"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by G.M</label>
                                                @if (auth()->user()->role == 'gm')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-2 row">
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by head</label>
                                                <textarea class="form-control" rows="3"name="conflict_management_comment_head"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by G.M</label>
                                                @if (auth()->user()->role == 'gm')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-2 row">
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by head</label>
                                                <textarea class="form-control" rows="3"name="time_effectiveness_time_responsiveness_availability_comment_head"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by G.M</label>
                                                @if (auth()->user()->role == 'gm')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-2 row">
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by head</label>
                                                <textarea class="form-control" rows="3"name="initiative_flexibility_comment_head"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by G.M</label>
                                                @if (auth()->user()->role == 'gm')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-2 row">
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by head</label>
                                                <textarea class="form-control" rows="3"name="cooperation_teamwork_comment_head"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by G.M</label>
                                                @if (auth()->user()->role == 'gm')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-2 row">
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by head</label>
                                                <textarea class="form-control" rows="3"name="knowledge_of_position_comment_head"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by G.M</label>
                                                @if (auth()->user()->role == 'gm')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-2 row">
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by head</label>
                                                <textarea class="form-control" rows="3"name="creativity_innovation_comment_head"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Comments by G.M</label>
                                                @if (auth()->user()->role == 'gm')
