        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <form action="{{ route('annual-employee-evaluation_by_gm.update', $evaluation->id) }}" method="post"
                            ...
                            <section class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="btn-group w-100" role="group">
                                        <input type="radio" class="btn-check" name="problem_solving" id="problem1"
                                            value="Exceeds expectations"
                                        ...
                                        <input type="radio" class="btn-check" name="problem_solving" id="problem2"
                                            value="Meets expectations"
                                        ...
                                        <input type="radio" class="btn-check" name="problem_solving" id="problem3"
                                            value="Needs improvement"
                                        ...
                                        <input type="radio" class="btn-check" name="problem_solving" id="problem4"
                                            value="Unacceptable"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mt-2 row">
                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label">Comments by G.M</label>
                                            <textarea class="form-control" rows="3"name="time_effectiveness_time_responsiveness_availability_comment_gm"readonly>{{$evaluation->time_effectiveness_time_responsiveness_availability_comment_gm}}</textarea>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mt-2 row">
                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label">Comments by G.M</label>
                                            <textarea class="form-control" rows="3"name="initiative_flexibility_comment_gm" readonly>{{$evaluation->initiative_flexibility_comment_gm}}</textarea>
