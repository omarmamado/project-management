 <div class="navbar-custom">
                <div class="container-fluid">
                    <ul class="mb-0 list-unstyled topnav-menu float-end">
                        ...
                        <li class="dropdown d-inline-block d-lg-none">
                            ...
                            <div class="p-0 dropdown-menu dropdown-lg dropdown-menu-end">
                                <form class="p-3">
       ...
       <a href="{{ route('admin.logout') }}" class="dropdown-item notify-item">
                    ...
                    <!-- LOGO -->
                    <div class="logo-box">
                        <a href="{{ url('/dashboard') }}" class="text-center logo logo-dark">
                            <span class="logo-sm">
                        ...
                        <a href="{{ url('/dashboard') }}" class="text-center logo logo-light">
                            <span class="logo-sm">
                                <img src="{{ asset('backend/assets/images/logo-sm.png') }}" alt="" height="50">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('backend/assets/images/logo-light.png') }}" alt="" height="50">
                            </span>
                        </a>
                    </div>
