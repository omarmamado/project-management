                    ...
                    <div class="text-center card">
                        <div class="card-body">
                            ...
                            <div class="mt-3 text-start">
                                ...
                                <p class="mb-2 text-muted font-13"><strong>Full Name :</strong> <span
                                        class="ms-2">{{ $adminData->name }}</span></p>

                                <p class="mb-2 text-muted font-13"><strong>Phone :</strong><span
                                        class="ms-2">{{ $adminData->phone }}</span></p>

                                <p class="mb-2 text-muted font-13"><strong>Email :</strong> <span
